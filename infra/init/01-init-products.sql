...
GRANT USAGE, CREATE ON SCHEMA public TO products_admin;
GRANT USAGE ON SCHEMA public TO products_reader;

-- Default privileges for future tables/sequences
ALTER DEFAULT PRIVILEGES FOR ROLE products_admin IN SCHEMA public
